    ...
    async def on_submit(self, interaction: discord.Interaction):
        ...
        if user_code == expected_code and user_color == expected_color:
            ...
            if role_add_error:
                ...
                embed = discord.Embed(
                    title="<:venus:1494667945505456159> Vérifié",
            ...
            disabled_venus = discord.ui.Button(
            ...
            disabled_view.add_item(disabled_venus)
...
class CaptchaButton(discord.ui.View):
    ...
    async def venus(self, interaction: discord.Interaction, button: discord.ui.Button):
